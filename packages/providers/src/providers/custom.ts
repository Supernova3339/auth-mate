...
import type { CustomProviderConfig, User } from '@auth-mate/core';

export class CustomProvider extends OAuthProvider {
    constructor(provider: string, private customConfig: CustomProviderConfig) {
        super(provider, customConfig);
    }

    async getAuthUrl(): Promise<string> {
        const state = generateState(this.provider);
